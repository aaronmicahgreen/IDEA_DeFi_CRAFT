...
apiURL = 'https://api.thegraph.com/subgraphs/name/aave/protocol-v2-avalanche'

con <- GraphqlClient$new(url = apiURL)

dataPath = "~/data/IDEA_DeFi_Research/Data/Lending_Protocols/Aave/V2/Avalanche/Raw/"
...
filePath = "~/DeFi_Data_Collection/Lending_Protocols/Aave/V2/Avalanche"
