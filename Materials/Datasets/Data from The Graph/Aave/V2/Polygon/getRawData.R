...
apiURL = 'https://api.thegraph.com/subgraphs/name/aave/aave-v2-matic'

con <- GraphqlClient$new(url = apiURL)

dataPath = "~/data/IDEA_DeFi_Research/Data/Lending_Protocols/Aave/V2/Polygon/Raw/"
...
filePath = "~/DeFi_Data_Collection/Lending_Protocols/Aave/V2/Polygon"
