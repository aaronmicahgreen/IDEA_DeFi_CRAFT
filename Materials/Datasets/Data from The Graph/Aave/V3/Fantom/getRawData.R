...
apiURL = 'https://api.thegraph.com/subgraphs/name/aave/protocol-v3-fantom'

con <- GraphqlClient$new(url = apiURL)

dataPath = "~/data/IDEA_DeFi_Research/Data/Lending_Protocols/Aave/V3/Fantom/Raw/"
...
filePath = "~/DeFi_Data_Collection/Lending_Protocols/Aave/V3/Fantom"
