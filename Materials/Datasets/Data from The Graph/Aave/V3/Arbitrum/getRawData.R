...
apiURL = 'https://api.thegraph.com/subgraphs/name/aave/protocol-v3-arbitrum'

con <- GraphqlClient$new(url = apiURL)

dataPath = "~/data/IDEA_DeFi_Research/Data/Lending_Protocols/Aave/V3/Arbitrum/Raw/"
...
filePath = "~/DeFi_Data_Collection/Lending_Protocols/Aave/V3/Arbitrum"
