...
apiURL <- "https://web3api.io/api/v2/defi/lending/compoundv2/protocol"
apiKey = Sys.getenv("AMBERDATA_API_KEY")
dataPath = "~/data/IDEA_DeFi_Research/Data/Lending_Protocols/Compound/V2/Ethereum/Raw/"
filePath = "~/DeFi_Data_Collection/Lending_Protocols/Compound/V2/Ethereum/getRawTables/"
`%notin%` <- Negate(`%in%`)
