...
filePath = "~/DeFi_Data_Collection/Lending_Protocols/Compound/V2/Ethereum"
dataPath = "~/data/IDEA_DeFi_Research/Data/Lending_Protocols/Compound/V2/Ethereum/"
