...
public class RequestManager {
	...
	private static final HashMap<String, Class<? extends RequestFramework>> templates = new HashMap<String, Class<? extends RequestFramework>>();
	private static final HashMap<String, RequestFramework> requests = new HashMap<String, RequestFramework>();
